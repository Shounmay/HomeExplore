...
import AdCreate from './pages/user/ads/AdCreate';
import PrivateRoute from './components/routes/PrivateRoute';
import SellHouse from './pages/user/ads/SellHouse';
import SellLand from './pages/user/ads/SellLand';
...
import AdEdit from './pages/user/ads/AdEdit';
import Wishlist from './pages/user/Wishlist';
import Enquires from './pages/user/Enquires';
				...
				<SearchProvider>
					...
					<Routes>
						...
						<Route path='/' element={<PrivateRoute />}>
							...
							<Route path='user/enquiries' element={<Enquires />} />
						</Route>
